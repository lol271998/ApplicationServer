...
public class MovieRecord extends UpdatableRecordImpl<MovieRecord> implements Record7<Integer, String, Integer, String[], Integer, String, String> {
    ...
    /**
     * Setter for <code>public.movie.link_pic</code>.
     */
    ...
    /**
     * Getter for <code>public.movie.link_pic</code>.
     */
    ...
    @Override
    public MovieRecord values(Integer value1, String value2, Integer value3, String[] value4, Integer value5, String value6, String value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MovieRecord(Integer movieId, String title, Integer releaseYear, String[] genre, Integer duration, String link, String linkPic) {
        super(Movie.MOVIE);
